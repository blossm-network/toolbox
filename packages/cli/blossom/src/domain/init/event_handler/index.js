...
module.exports = async () => {
  ...
  console.log(roboSay("Initializing an event handler codebase..."));
  ...
  try {
    ...
    console.error(
      roboSay(
        "The event handler template is unreachable. Reach out to bugs@sustainers.market please, it's in everyone's best interest.",
