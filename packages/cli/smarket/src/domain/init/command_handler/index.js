...
module.exports = async () => {
  ...
  console.log(roboSay("Initializing a command handler codebase..."));
  ...
  try {
    ...
    console.error(
      roboSay(
        "The command handler template is unreachable. Reach out to bugs@sustainers.market please, it's in everyone's best interest.",
  ...
  console.log(
    roboSay(
      "When you wanna deploy, type `smarket command command-handler deploy .`"
    )
  );
