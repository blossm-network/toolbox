...
describe("View store get", () => {
  ...
  //       id: results[i].headers.id,
  //       updates:
  //         "http://updates.some-core-network/channel?query%5Bname%5D=some-env-name&query%5Bnetwork%5D=some-env-network&query%5Bprincipal%5D=some-context-principal-root",
  //     });
  //   }
  //   expect(sendFake).to.have.been.calledWith({
  //     content: formattedResults.map((r) => ({
