  ...
  _eventStore = deps.db.store({
    ...
    schema: {
      ...
      headers: {
        ...
        pHash: { [typeKey]: Buffer, required: true },
        cHash: { [typeKey]: Buffer, required: true },
        sHash: { [typeKey]: Buffer, required: true },
        committed: {
          [typeKey]: Date,
          required: true,
        },
  ...
  _snapshotStore = deps.db.store({
    ...
    schema: {
      ...
      headers: {
        ...
        eRoot: { [typeKey]: Buffer, required: true },
        _id: false,
      },
      context: { [typeKey]: Object },
      state: schema,
...
const blockchainStore = async () => {
  ...
  _blockchainStore = deps.db.store({
    ...
    schema: {
      hash: { [typeKey]: String, required: true, unique: true },
      signature: { [typeKey]: Buffer, required: true },
      headers: {
        nonce: {
          [typeKey]: String,
          required: true,
        ...
        eRoot: { [typeKey]: Buffer, required: true },
        sRoot: { [typeKey]: Buffer, required: true },
        domain: { [typeKey]: String, required: true },
        service: { [typeKey]: String, required: true },
        network: { [typeKey]: String, required: true },
