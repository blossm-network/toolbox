    ...
    expect(storeFake.getCall(0)).to.have.been.calledWith({
      ...
      schema: {
        ...
        headers: {
          ...
          pHash: { $type: Buffer, required: true },
          cHash: { $type: Buffer, required: true },
          sHash: { $type: Buffer, required: true },
          committed: {
            $type: Date,
            required: true,
          },
    ...
    expect(storeFake.getCall(1)).to.have.been.calledWith({
      ...
      schema: {
        ...
        headers: {
          ...
          eRoot: { $type: Buffer, required: true },
          _id: false,
        },
        context: { $type: Object },
    ...
    expect(storeFake.getCall(3)).to.have.been.calledWith({
      ...
      schema: {
        ...
        headers: {
          ...
          eRoot: { $type: Buffer, required: true },
          sRoot: { $type: Buffer, required: true },
          domain: { $type: String, required: true },
          service: { $type: String, required: true },
          network: { $type: String, required: true },
